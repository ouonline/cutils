...
dep1:AddFlags("-Wall", "-Werror", "-Wextra")
...
dep2:AddFlags("-Wall", "-Werror", "-Wextra")
...
dep3:AddFlags("-Wall", "-Werror", "-Wextra")
...
dep4:AddFlags("-Wall", "-Werror", "-Wextra")
...
dep5:AddFlags("-Wall", "-Werror", "-Wextra")
