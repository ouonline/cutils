...
void rb_destroy(struct rb_root*, void*, void (*del_func)(struct rb_node*, void*));
...
struct rb_node* rb_insert(struct rb_node*, struct rb_root*,
                          int (*cmp_func)(struct rb_node*, struct rb_node*));

void rb_delete(struct rb_node*, struct rb_root*);

struct rb_node* rb_root(struct rb_node*);
